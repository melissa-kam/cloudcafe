...
from cloudcafe.cloudkeep.barbican.tokens_api.models.requests.auth import \
    Auth as AuthRequest
from cloudcafe.cloudkeep.barbican.tokens_api.models.responses.access import \
    Access as AuthResponse
from cloudcafe.cloudkeep.barbican.tokens_api.models.requests.credentials \
    import PasswordCredentials
